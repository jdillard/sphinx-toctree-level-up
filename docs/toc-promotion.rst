...
HTML sidebars and numbering then read the promoted ``env.tocs``. The in-page toctree stays in the original doctree, which is why paragraph-before / list / paragraph-after order is unchanged.
